...
Ho = There is no relationship, beta = 0
Ha = There is a relationship, beta =/= 0
...
We are able to reject the null hypothesis as p-value is less than 0.05. One increase in anxiety leads to 37 decrease in satisfaction.
...
\vspace{0.5in}
As age increases, satisfaction decreases

- Interpret coefficient of determination. 
\vspace{0.5in}

The R squared is 0.497 so there is some relation
...
```{r}
survey5 = survey2 %>%
  mutate(fitted = predict(inter.lm2, newdata = .), 
         residuals = satisfaction - fitted)
