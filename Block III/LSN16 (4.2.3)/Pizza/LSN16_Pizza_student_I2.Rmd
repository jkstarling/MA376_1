...
pizza.dat %>% ggplot(aes(x=Calories, y=Rating,color=Pepperoni)) + geom_boxplot()
pizza.dat %>% ggplot(aes(x=Calories, y=Rating)) + geom_density2d_filled() 

pizza.dat %>% ggplot(aes(x=Calories, y=Fat)) + geom_point()
