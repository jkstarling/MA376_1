...
```{r}
fg.attempts <- length(fg$kick_distance) 
...
table(fg$field_goal_result, fg.surf.pred)

fg.surf.rate <- (381+100) / fg.attempts

# using distance model
fg.dist.pred <- ifelse(distance.glm$fitted.values >= my.rate, "made.p", "missed.p")
table(fg$field_goal_result, fg.dist.pred)

fg.dist.rate <- (614+115) / fg.attempts
