...
diet.lm <- dietdat %>% lm(wloss~0+diet, data=.)
...
geom_boxplot() + stat_summary(fun=mean, geom="point", shape=20, size=5, color="red", fill="red") + labs(title="boxlot of weight loss by diet type", y="weight loss (kg)")
```
...
TukeyHSD(diet.aov, conf.level = 0.99)
```
