...
a. *Use the Comparing Two Populations (we will use R) applet with both means set to 80. Use a significance level of 0.05.  Which of the following is the best rejection region for detecting that the population mean heart rate after jumping is higher than after sitting?*
...
```{r}
qt(0.025, df = 10 - 1, lower.tail = FALSE) * 8 / sqrt(10)
```
\vspace{0.5in}
