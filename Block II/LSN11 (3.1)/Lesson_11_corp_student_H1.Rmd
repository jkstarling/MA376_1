...
cred %>% group_by(Treatments) %>% summarise(mn = mean(PI), 
                                            SD = sd(PI))
...
# credibility 95% CI:
c( 2*1.4875 - 2*4.455 * sqrt(1/20), 2*1.4875 + 2*4.455 * sqrt(1/20))
# endorser 95% CI:
c( 2*1.3125 - 2*4.455 * sqrt(1/20), 2*1.3125 + 2*4.455 * sqrt(1/20))
